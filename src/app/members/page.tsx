    ...
    <div className="w-full min-h-screen py-24 px-4 bg-[#fdf6e3]">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20 relative">
          ...
          <div className="w-full max-w-lg mx-auto h-2 bg-[#ff728d] mt-2 mb-6 transform -rotate-1 opacity-60" />
          ...
          <div className="absolute top-0 right-10 md:right-1/4 bg-[#ffe082] px-4 py-2 rotate-6 shadow-ambient">
            <span style={{ fontFamily: "var(--font-jakarta)" }} className="font-bold text-sm uppercase tracking-wider">Certified Goofs</span>
            <div className="absolute top-0 left-1/2 w-8 h-4 bg-white/40 transform -translate-x-1/2 -mt-2 -rotate-2 rounded-sm" />
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 lg:gap-12 pb-32">
        ...
        <div className="max-w-3xl mx-auto bg-[#efe8d2] p-8 md:p-12 shadow-[8px_8px_0px_#a8e6cf] border-4 border-[#322f22] rounded-sm text-center relative rotate-1 mb-16">
          <div className="absolute -top-4 -left-4 w-12 h-12 bg-[#ff728d] rounded-full flex items-center justify-center shadow-sm border-2 border-[#322f22]">
            <span className="text-xl">
              <svg
                     viewBox="0 0 24 24"
                     className="w-8 h-8 text-[#e5f48f]"
                     fill="currentColor"
          ...
          <h2 className="text-4xl font-black mb-6 text-[#322f22] uppercase tracking-tighter" style={{ fontFamily: "var(--font-jakarta)" }}>What exactly is a Goofie?</h2>
          <p style={{ fontFamily: "var(--font-caveat)" }} className="text-[#322f22]/90 mb-8 text-3xl leading-snug">
          ...
          <div style={{ fontFamily: "var(--font-vietnam)" }} className="flex flex-wrap justify-center gap-4">
            <span className="bg-[#ffe082] text-[#322f22] px-4 py-2 font-black text-sm uppercase tracking-widest border-2 border-[#322f22] rotate-2 shadow-[2px_2px_0px_#322f22]">Loud Laughers</span>
            <span className="bg-white text-[#322f22] px-4 py-2 font-black text-sm uppercase tracking-widest border-2 border-[#322f22] -rotate-1 shadow-[2px_2px_0px_#322f22]">Bad Idea Enthusiasts</span>
            <span className="bg-[#ff728d] text-white px-4 py-2 font-black text-sm uppercase tracking-widest border-2 border-[#322f22] rotate-3 shadow-[2px_2px_0px_#322f22]">Unfiltered</span>
          </div>
        </div>
      </div>
    </div>
