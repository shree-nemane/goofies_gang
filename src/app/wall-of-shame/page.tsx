    ...
    <div className="w-full min-h-screen py-24 px-4 bg-[#fdf6e3]">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16 relative">
          <div className="absolute top-1/2 left-0 w-full h-px border-t border-dashed border-[#d8cdae] -z-10" />
          <h1 className="text-5xl md:text-7xl font-black text-[#322f22] bg-[#fdf6e3] inline-block px-8 tracking-tighter" style={{ fontFamily: "var(--font-jakarta)" }}>
            THE <span className="text-[#b31446]">BURN</span> UNIT
          </h1>
          <div className="absolute right-0 top-1/2 transform -translate-y-1/2 text-[#b31446]">
            🔥
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-start">
          ...
          <div className="w-full lg:w-80 flex-shrink-0">
             <div className="bg-[#efe8d2] p-6 rounded-sm shadow-ambient mb-8 relative rotate-1">
               <div className="absolute top-2 right-4 text-6xl text-[#d8cdae] -rotate-12 opacity-50 z-0">
                 ↘
               </div>
               <h3 style={{ fontFamily: "var(--font-jakarta)" }} className="font-black text-xl mb-4 text-[#322f22] relative z-10 border-b border-[#ebdcb9] pb-2">TODAY'S ROAST LEADERBOARD</h3>
               
               <RoastLeaderboard roasts={roasts} />

               {/* Instruction */}
               <div style={{ fontFamily: "var(--font-vietnam)" }} className="w-full mt-2 text-center text-[10px] font-black uppercase text-[#322f22]/50 tracking-widest">
                 +1 Burn for every Roast.<br/>+1 for every 🔥 Reaction.
               </div>
             </div>

             <div className="bg-[#ffe082] p-6 shadow-ambient -rotate-2">
